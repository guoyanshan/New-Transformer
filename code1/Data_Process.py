...
class MyData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x_up_ms = int(4 * x_ms)
        y_up_ms = int(4 * y_ms)
        x_down_up_pan = int(4 * x_ms)
        y_down_up_pan = int(4 * y_ms)
        ...
        image_down_up_pan = self.train_data3[:, x_down_up_pan:x_down_up_pan + self.cut_pan_ms_size, y_down_up_pan:y_down_up_pan + self.cut_pan_ms_size]
        ...
        return image_ms, image_up_ms, image_down_up_pan, image_pan, target, locate_xy
